...
def net_out2rgb(L, ab_out):
    ...
    # L and ab_out are tensor, i.e., are of shape Height x Width x Channels
    ...
    #   - http://scikit-image.org/docs/dev/user_guide/data_types.html
    #   - idk what's next, but converting image to float64 somehow
    #     does the job. scikit-image automagically converts those values.
    img_stack = img_stack.astype(np.float64)	
    
    # Use scikit-image's lab2rgb
    return color.lab2rgb(img_stack)
